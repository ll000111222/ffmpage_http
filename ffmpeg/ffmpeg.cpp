                ...
                if (index == videoStreamIndex) {
                    ...
                    if (frameFinish >= 0) {
                        ...
                        if (!image.isNull()) {
                            ...
                            double vedioSecond = avFrame2->best_effort_timestamp * av_q2d(audioStream->time_base);
                            //
                            emit sendCurTime(vedioSecond);
                            qDebug()<<vedioSecond;
...
FFmpegThread* FFmpegWidget::getFFmpegThread()
{
    return thread;
}
